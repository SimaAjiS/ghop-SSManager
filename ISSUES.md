...
- **表示項目の整理**: 全カラムを表示するのではなく、重要な項目を優先的に表示する。
- **グルーピング**: 関連する項目（例: 電気的特性、物理的特性、管理情報など）をグループ化して表示する。
- **レイアウト改善**: 視認性を高めるためのスタイル調整（見出し、区切り線、アイコンの活用など）。
- **動的表示**: デバイスタイプやデータの内容に応じて、表示する項目やレイアウトを動的に変更する仕組み（必要であれば）。

**タスク**

- [ ] 表示すべき項目とグルーピングの定義
- [ ] Detail Drawer コンポーネントのレイアウト改修
- [ ] 不要な内部 ID などの非表示化
- [ ] スタイリングの調整（見やすさの向上）
